...
class OpenAIClient:
    ...
    def create_gpt4o_response(self, question, chat_id):
        ...
        if not complex_names and ("там" in question.lower() or "что есть" in question.lower()):
            ...
            self.conversation_manager.add_message(chat_id, "assistant", clarification)
        ...
        self.conversation_manager.add_message(chat_id, "user", f"Пользователь задал вопрос:\n{question}")
    ...
    def load_knowledge_files(self, files):
